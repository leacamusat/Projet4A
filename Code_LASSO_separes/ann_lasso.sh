...
echo "You should have a repository with two folders : train and test with training files named like ass37.csv"
srun python ./calcul_lambda_qut.py ./MNIST5 37 4
echo "end of lambda_qut calculation"
srun python ./train_model.py ./MNIST5 37 4
echo "end of training phase"
srun python ./test_model.py ./MNIST5 37 4
echo "end of testing phase"
