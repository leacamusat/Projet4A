...
def TFmodel(Xsample,Ysample,p2,activation_function,lamb,learningRate,
    ...
    if np.any(Xtest):
        ...
        p_test_hat = None
        y_test_hat = None
    return [w1,w2,c, p_hat, y_hat, p_test_hat,y_test_hat,cost,learningRate, p_hat]
...
def TFmodelfit(X,y,p2,activation_function,lamb,learningRate0,withSD,ifTrain=True,iterationISTA=3000, Xtest=None, iniscale=0.01):
    ...
    lro=learningRate0[0]
    [w10,w20,c0,p_hat_0,y_hat_0,p_test_hat_0,y_test_hat_0,cost_0,lro_0, p_hat_0] = TFmodel(X,y,p2,activation_function,lamb,lro,withSD=False,ifTrain=True,iterationISTA=-999,  Xtest=Xtest, iniscale=iniscale)
    [w1o,w2o,co,p_hat_o,y_hat_o,p_test_hat_o,y_test_hat_o,cost_o,lro_o, p_hato_o] = TFmodel(X,y,p2,activation_function,lamb,lro_0,withSD,ifTrain=True,iterationISTA=iterationISTA,  Xtest=Xtest, iniscale=iniscale,w1_ini=w10, w2_ini=w20, c_ini=c0)
    
    for lr in learningRate0[1:]:
        [w1oo,w2oo,coo,p_hat_oo,y_hat_oo,p_test_hat_oo,y_test_hat_oo,cost_oo,lro_oo, p_hatoo]= TFmodel(X,y,p2,activation_function,lamb,lr,withSD,ifTrain=True,iterationISTA=iterationISTA, Xtest=Xtest, iniscale=iniscale,w1_ini=w10, w2_ini=w20, c_ini=c0)
        if (cost_oo<cost_o):
            cost_o=cost_oo
            w1o=w1oo
            w2o=w2oo
            ...
            break
    return [w1o,w2o,co,p_hat_o,y_hat_o,p_test_hat_o,y_test_hat_o,cost_o,lro_o, p_hat_o] 
...
def resultanalysis(w1o,y_test,y_test_hat_o,needles_index_true=None):
    ...
    if np.any(y_test)!=None:
        ...
        accuracy=None
    return needles_index_hat,tpr,fdr,hat_equal_true,confusion_matrix,accuracy, neuron_index
...
def computeResults(x_train,y_train,learningRate_list,iniscale,lambda_qut,p2,x_test=None,y_test=None):
    ...
    needles_index_hat,tpr,fdr,hat_equal_true,confusion_matrix,accuracy, neuron_index=resultanalysis(w1o,y_test,y_test_hat_o)
    return w1o,w2o,co,p_hat_o,y_hat_o,p_test_hat_o,y_test_hat_o,cost_o,lro,needles_index_hat,tpr,fdr,hat_equal_true,confusion_matrix,accuracy, neuron_index, p_hat_o
